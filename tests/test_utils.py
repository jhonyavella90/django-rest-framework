...
import rest_framework_tm.utils.model_meta
from rest_framework_tm.utils.breadcrumbs import get_breadcrumbs
from rest_framework_tm.utils.model_meta import _resolve_model
...
class ResolveModelWithPatchedDjangoTests(TestCase):
    ...
    def setUp(self):
        ...
        self.get_model = rest_framework_tm.utils.model_meta.models.get_model

        def get_model(app_label, model_name):
            return None

        rest_framework_tm.utils.model_meta.models.get_model = get_model

    def tearDown(self):
        """Revert monkeypatching."""
        rest_framework_tm.utils.model_meta.models.get_model = self.get_model
